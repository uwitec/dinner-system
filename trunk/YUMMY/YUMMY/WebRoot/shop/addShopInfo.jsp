...
<body topmargin="80" leftmargin="100"
	background="YUMMY/WebRoot/picture/text/background.jpg">
	<a href="index.jsp"><img src="/YUMMY/picture/logo.jpg" width="250"
		height="88">
	</a>
	<form action="addShop" method="post">
		<table>
			...
			<tr>
				<td colspan="3"><img id="logo_img"
					src="../images/shop/default_logo.jpg" width="200" height="100">
				</td>
			</tr>
			<tr>
				<td>餐厅介绍</td>
				<td><textarea rows="5" cols="80" name="introduction"></textarea>
				</td>
			</tr>
			<tr>
				<td>餐厅地址</td>
